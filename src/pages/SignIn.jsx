...
const SignIn = () => {
  return (
    <div className="m-auto w-[100%] md:w-1/2 h-[100%] bg-[#e6e6e6]">
      <Navbar />
      <section className="px-5 py-3 md:px-4 md:py-10 mt-[6rem]  md:mt-[10rem] bg-[#475569] rounded-3xl shadow-2xl mx-5 md:mx-0 ">
        <section className="mt-[8rem] w-full text-center m-0 p-0">
          ...
          <div className="justify-between md:flex md:flex-cols-2">
            <div className="text-center md:w-1/2">
              ...
              <p className="my-10 font-medium text-[18px] text-start leading-8 md:w-[80%]">
                We Executed Partnership with Nigerian Postal Services (NIPOST)
                for deployment of Smart Lockers across 774 local governments and
                955 post offices with over 3000 postal agencies across Nigeria.
              </p>
            </div>
            ...
            <div class=" md:w-[25%] rounded-xl overflow-hidden shadow-lg bg-[#ffffffff] py-10 pl-9 items-center">
              ...
              <div class=" py-4 text-start ">
                ...
                <p class="text-gray-700 font-semibold text-[16px] text-start leading-8 w-[80%]">
                  Spend less to send and receive your packages with our
                  affordable pricing.
                </p>
              </div>
            </div>
        ...
        <footer className="bg-[#FF6000] md:px-24 px-5 py-16 text-white md:text-[20px] text-[16px]">
          <div className="justify-between text-center md:flex flex-cols-3 ">
            <div className="md:w-[35%]">
              ...
              <div>
                <p className="my-5 leading-10 text-center md:my-0 md:text-start ">
                  The Premier Smartlocker Solution for Logistics in Nigeria. Our
                  SmartParcel Lockers are express self-servicing machines
                  designed to automate pick-up and delivery of packages.
                </p>
              </div>
            </div>
            ...
            <div className="md:w-[15%] text-start mt-10">
              ...
              <p className="mt-5">
                No 9, MacDonald Ikoyi, Lagos State, Nigeria.
              </p>
