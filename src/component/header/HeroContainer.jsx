    ...
    return (
        <>
            ...
            <section className="my-[8rem] w-full text-center ">
                <div className="justify-between px-5 text-center items-center md:grid md:grid-cols-2 md:px-28 md:text-start">
                    <div>
                        <div className="font-extrabold md:text-[4rem] text-[2rem] w-full"
                        data-aos='slide-right'
                        data-aos-duration="2000"
                        >
                            <h1 className="leading-[1.2]">Secured <br /> Simplified Logistics <br /> for <span className="text-[#FF6000]">Africa</span></h1>
                        </div>
                        <p className="md:w-[85%] tracking-wider my-12 text-[17px]" data-aos='slide-right'
